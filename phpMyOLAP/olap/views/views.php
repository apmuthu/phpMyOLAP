...
print "<table border=0>";
  print "<tr valign=top>";
    ...
    print "</td>";
    print "<td>";
      print "<a style='width:120px' href='#' title='Save' onclick='save(\"$cubename_sel\",\"$level_ser\")'><img src='$img_save' width=32px height=32px></a>";
    print "</td>";
    print "<td valign=top>";
...
print "<table align=center>";
  print "<tr>";
    ...
    print "</td>";
    print "<td valign=top>";
      print "<a style='width:120px' class='button' href='#' onclick=\"document.getElementById('divSD').style.visibility='visible';\">Slice-and-Dice</a>";
    print "</td>";
    print "<td valign=top>";
      print "<a style='width:120px' class='button' href='#' onclick=\"document.getElementById('divDrillAcross').style.visibility='visible';\">Drill-across</a>";
    print "</td>";
    print "<td valign=top>";
