...
print "<table>";
  print "<tr>";
    ...
    print "</td>";
    print "<td>";
      print "<a class='button' href='#' onclick='addSD()'>Aggiungi</a>";
    print "</td>";
  print "</tr>";
  print "<tr>";
    print "<td colspan=3>";
    ...
    print "<td valign='bottom'>";
      print "<a class='button' href='#' onclick='delSD()'>Cancella</a>";
    print "</td>";
  print "</tr>";
print "</table>";
...
print "<table>";
  print "<tr>";
    ...
    print "</td>";
    print "<td align=center>";
      print "<a class='button' href='#' onclick=\"document.getElementById('divSD').style.visibility='hidden';\">Annulla</a>";
    print "</td>";
  print "</tr>";
print "</table>";
